...
describe("Describe entity assertions", () => {
  ...
  test('Update weight of asset', () => {
    let updateWeightEvent = createUpdateAnatomyEvent(Address.fromString('0x0000000000000000000000000000000000000002'),150)
    handleUpdateAnatomy(updateWeightEvent)
    assert.fieldEquals('Index','0xa16081f360e3847006db660bae1c6d1b2e17ec2a','assets','[0x0000000000000000000000000000000000000001, 0x0000000000000000000000000000000000000002]')
    assert.fieldEquals('Index','0xa16081f360e3847006db660bae1c6d1b2e17ec2a','weights','[50, 150]')
  ...
  test('Check removal of asset',() => {
    ...
    assert.fieldEquals('Index','0xa16081f360e3847006db660bae1c6d1b2e17ec2a','weights','[150]')
  })
